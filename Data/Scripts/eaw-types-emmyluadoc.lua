...
---@public
---@param ability_name_or_object_name string The ability to (de-)activate. In galactic mode, this can be the name of a GameObjectType.
---@param should_activate boolean Activates the ability if true, deactivates if false.
---@overload fun()
---@overload fun(ability_name_or_object_name:string)
---Activates or deactivates a given ability. In Galactic mode, can have 0 or 1 arguments.
function GameObject.Activate_Ability(ability_name_or_object_name, should_activate) end
---@public
---@return boolean
...
---@public
---@param ability_name string
---@param custom_recharge_time? number
function GameObject.Force_Ability_Recharge(ability_name, custom_recharge_time) end
---@public
---@param ability_name string
...
---@public
---@param object GameObjectWrapper Specific object to get the bribe cost for
---@return number
...
---@public
---@param object_type GameObjectType
function PlayerObject.Lock_Tech(object_type) end
---@public
...
---@public
---@return PlayerObject
function PlanetObject.Get_Owner() end

---@public
---@param new_owner PlayerObject
function PlanetObject.Change_Owner(new_owner) end
...
---@class WeightedTypeList
WeightedTypeList = {}

---@public
---@return WeightedTypeList
function WeightedTypeList.Create() end

---@public
---@param typeNames string[] The names of the types to parse.
---@param weights number[] The weights of the types to parse.
function WeightedTypeList.Parse(typeNames, weights) end
...
function DiscreteDistribution.Create() end

---@public
---@param item any
---@param weight number
function DiscreteDistribution.Insert(item, weight) end

---@public
---@return any
function DiscreteDistribution.Sample() end