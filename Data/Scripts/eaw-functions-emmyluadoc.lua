...
---@public
---@param object_or_hint string The object or hint name to search for.
...
function Find_Hint(object_or_hint, hint) end
---@public
---@param hint string The object hint as set in the map editor.
---@return GameObject[]
...
---@param player PlayerObject The owner of the unit
...
---@param resume_sound? boolean Default is true. Resume sound playback.
...
---@param type_list WeightedTypeList
---@return number
function EvaluateTypeList(player, target, type_list) end
...
---@param player PlayerObject
---@param position Position|GameObjectWrapper
---@param radius? number
---@return FowRevealClass
...
---@param player PlayerObject
---@return number
function Evaluate_In_Galactic_Context(perception, player) end
---@public
---@param player PlayerObject
...
---@param perception string
---@param player PlayerObject
---@param target GameObject|PlayerObject|AITarget|PlanetObject
---@return number
...
---@public
---@param space_or_ground? boolean `true` for space, `false` for ground, nil for all
---@return number
function FreeStore.Get_Object_Count(space_or_ground) end
---@public
---@param game_object GameObject
---@return boolean
...
---@public
function Declare_Goal_Type() end
...
---@public
---@param component string The name of the GUI component to be modified
---@param visible boolean If true, the component will be made visible, false it will be hidden.
function GUI_Component_Visibility(component, visible) end
---@public
---@param component string The name of the GUI component to be modified
---@param enabled boolean If true, the component will be enabled, false it will be disabled.
function GUI_Component_Enable(component, enabled) end
---@public
---@param component string The name of the GUI component to be modified
---@param text string The text to be displayed in the component
function GUI_Component_Text(component, text) end
---@public
---@param component string The name of the GUI component to be modified
---@param icon string The icon texture to be displayed in the component
---@param r number
---@param g number
---@param b number
---@param a number
