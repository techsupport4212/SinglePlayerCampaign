...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Light_Vehicle_Factory | Holdout_Factory | A_Ground_Light_Vehicle_Factory | T_Ground_Light_Vehicle_Factory | Z_Ground_Light_Vehicle_Factory | C_Ground_Light_Vehicle_Factory |  R_Ground_Light_Vehicle_Factory | P_Ground_Light_Vehicle_Factory | EOTH_Ground_Light_Vehicle_Factory | HC_Ground_Light_Vehicle_Factory | H_Ground_Light_Vehicle_Factory | I_Ground_Light_Vehicle_Factory | Y_Ground_Light_Vehicle_Factory = 1"
	}
	}
