...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Barracks | Holdout_Barracks | A_Ground_Barracks | T_Ground_Barracks | Z_Ground_Barracks | C_Ground_Barracks | R_Ground_Barracks | EOTH_Ground_Barracks | P_Ground_Barracks | HC_Ground_Barracks | H_Ground_Barracks | Y_Ground_Barracks | I_Ground_Barracks = 1"
	}
	}
