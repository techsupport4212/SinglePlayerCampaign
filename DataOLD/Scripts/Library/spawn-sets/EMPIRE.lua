return {
	Space_Unit_Table = {
		{"Beta_ETR_3_Group", 2, StartYear = 4}
		,{"IPV1", 5}
		,{"Action_VI_Refit", 1, StartYear = 4}
		,{"Crusader_Gunship", 5, StartYear = 12}
		,{"Lancer_Frigate", 4}
		,{"Patrol_Nebulon_B", 4}
		,{"Ton_Falk_Escort_Carrier", 3}
		,{"Carrack_Cruiser", 4, StartYear = 4}
		,{"Strike_Cruiser", 4}
		,{"Eidolon", 4, LastYear = 5}
		,{"Vindicator_Cruiser", 3, StartYear = 4}
		,{"Imperial_DHC", 4}
		,{"Star_Galleon", 1}
		,{"Acclamator_II", 3, StartYear = 4}
		,{"Procursator_Star_Destroyer", 2, StartYear = 4}
		,{"Victory_I_Star_Destroyer", 3}
		,{"Victory_II_Star_Destroyer", 3}
		,{"Imperial_II_Star_Destroyer", 1, StartYear = 4}
	...
	Land_Unit_Table = {
		...
		,{"Imperial_Army_Guard_Company", 3, StartYear = 4}
		,{"Imperial_Navy_Trooper_Company", 1, StartYear = 4}
		,{"Imperial_Stormtrooper_Company", 2}
		,{"Destroyer_Droid_I_W_Company", 0.5, StartYear = 4}
		,{"Imperial_Dwarf_Spider_Droid_Company", 2, StartYear = 12}
		,{"Shadow_Stormtrooper_Company", 0.3, StartYear = 4}
