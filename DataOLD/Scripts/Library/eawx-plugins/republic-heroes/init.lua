...
require("eawx-plugins/republic-heroes/CommandStaffManager")
...
return {
    ...
    init = function(self, ctx)
        ...
        ---@type CommandStaffManager
        CommandStaffManager(galactic_conquest, ctx.id, galactic_conquest.HumanPlayer)
